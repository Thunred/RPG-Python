...
from item import Knife, jaws, short_bow, claws, dragon_breath, boss_weapon
...
troll = Enemy("Troll", 30,4, Knife)
ogre = Enemy("Ogre", 35,5, Knife)
dragon = Enemy("Dragon", 50,10, dragon_breath)
wolf = Enemy("Wolf", 15,2, claws)
panda = Enemy("Panda", 25,3, jaws)
fenrir = Enemy("Fenrir", 40,5, claws)
dev = Enemy("Devil", 60,5, claws)

boss = Enemy(name="Boss", health=100,defense_points=10, weapon=boss_weapon)